...
public class InputManager : MonoBehaviour
{
    ...
    private bool DetectDoubleTap(string action)
    {
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (inputManager.inputType == INPUTTYPE.TOUCHSCREEN)
        {
            EditorGUILayout.LabelField(
                "* You can edit the touchscreen buttons in the 'UI' prefab in the project folder.");
        ...
        if (inputManager.inputType == INPUTTYPE.KEYBOARD || inputManager.inputType == INPUTTYPE.JOYPAD)
        {
            ...
            bool showDeleteButton =
                (inputManager.inputType == INPUTTYPE.KEYBOARD && inputManager.keyBoardControls.Count > 0) ||
