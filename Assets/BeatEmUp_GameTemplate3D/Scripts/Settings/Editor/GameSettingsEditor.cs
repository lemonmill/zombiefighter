...
public class GameSettingsEditor : EditorWindow
{
    ...
    void DisplayMainArea()
    {
        ...
        settings.SFXVolume =
            EditorGUILayout.FloatField(new GUIContent("SFX Volume: "), Mathf.Clamp(settings.SFXVolume, 0f, 1f));
        settings.MusicVolume =
            EditorGUILayout.FloatField(new GUIContent("Music Volume: "), Mathf.Clamp(settings.MusicVolume, 0f, 1f));
        EditorGUILayout.Space();
    }
}
