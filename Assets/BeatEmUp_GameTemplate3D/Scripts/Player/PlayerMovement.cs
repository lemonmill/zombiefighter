...
public class PlayerMovement : MonoBehaviour {
	...
	public static ReactiveProperty<HealthSystem> playerSpawned = new ReactiveProperty<HealthSystem>();
	...
	{
		playerSpawned.Value = GetComponent<HealthSystem>();
	...
	private void OnDirectionInputEvent(Vector2 dir, bool doubleTapActive) {
		...
		if(doubleTapActive && IsGrounded() && Mathf.Abs(dir.x)>0)
		{
